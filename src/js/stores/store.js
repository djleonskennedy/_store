...
for( let i = 1; i < 9; i++ ) {
	_catalog.push( {
		"id": 'Widget' + i,
		"title": 'Widget #' + i,
		"summary": "Coollest stuff !!",
		"description": 'There are important differences between plain text files created by a text editor and document.',
		"cost": i
	} )
}
	...
	dispatcherIndex: register( function( action ){
		switch( action.actionType ){
			...
			case AppConstants.INCREASE_ITEM:
				...
				break;
			case AppConstants.DICREASE_ITEM:
